...
func TestFizzBuzz(t *testing.T) {
	assert.Equal(t, "12Fizz", FizzBuzz(3))
	assert.Equal(t, "12Fizz4BuzzFizz", FizzBuzz(6))
	assert.Equal(t, "12Fizz4BuzzFizz78Fizz", FizzBuzz(9))
	assert.Equal(t, "12Fizz4BuzzFizz78FizzBuzz11Fizz1314FizzBuzz", FizzBuzz(15))
}
